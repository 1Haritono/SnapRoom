...
import { RotateCw, Trash2, Box, Move, Layers, X } from 'lucide-react';
import { MaterialSelector } from './MaterialSelector';

export const SelectedModulePanel: React.FC = () => {
  const { modules, selectedModuleId, setSelectedModuleId, updateModule, removeModule } = useAppStore();
  ...
  return (
    <div className="absolute bottom-4 right-4 z-30 w-96 bg-slate-900/95 border border-indigo-500/60 rounded-xl shadow-2xl backdrop-blur p-4 space-y-3 text-slate-200 text-xs animate-in fade-in slide-in-from-bottom-4 duration-200">
